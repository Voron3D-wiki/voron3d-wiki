...
|:-------|:-----:|:------------|:----------|
| [Eddy](/bedleveling/eddy/) | ![Eddy-USB](eddyUSB-min.png) | - USB connectivity<br />- High precision<br />- Non-contact | [Details](/bedleveling/eddy/) |
| [Eddy Coil](/bedleveling/eddy-coil/) | ![Eddy-IC2](eddy-IC2-min.png) | - I2C interface<br />- Compact design<br />- Fast response | [Details](/bedleveling/eddy-coil/) |
| [Beacon3D](/bedleveling/beacon/) | ![Beacon3D](RevH8-min.png) | - Multiple sensing modes<br />- Auto Z-offset<br />- High accuracy | [Details](/bedleveling/beacon/) |
| [Cartographer](/bedleveling/cartographer/) | ![Cartographer](RevH8-min.png) | - Advanced algorithms<br />- Multi-material support<br />- Fast scanning | [Details](/bedleveling/cartographer/) |
...
| Beacon3D Poke | ![Beacon Poke](RevH8-min.png) | - Dual-mode operation<br />- Auto-calibration<br />- High precision | [Details](/bedleveling/beacon/) |
...
|:-------|:-----:|:------------|:----------|
| Beacon3D Poke | ![Beacon Poke](RevH8-min.png) | - Automatic calibration<br />- Real-time adjustment<br />- Multi-material support | [Details](/bedleveling/beacon/) |
| Eddy Auto-Z | ![Eddy Auto-Z](eddyUSB-min.png) | - Non-contact measurement<br />- High precision<br />- Fast response | [Details](/bedleveling/eddy/) |
