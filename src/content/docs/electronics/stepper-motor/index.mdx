...
slug: 'electronics/stepper-motor'
---

import AffiliateDisclosure from '~/components/AffiliateDisclosure.astro';
import IncElectronicsStepperMotorDatabase from './database/index.mdx';
...
<a href="https://stepper-sim.devminer.xyz/" target="_blank" rel="noopener" className="md-button">
...
<IncElectronicsStepperMotorDatabase />
