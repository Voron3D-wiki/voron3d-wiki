...
import imgFridgeDoor from './voron v0 fridge door.jpg';

import AffiliateDisclosure from '~/components/AffiliateDisclosure.astro';
import IncPrintersV0Bom from './bom/index.mdx';
...
<details>
<summary>Offical Voron V0.2 R1 bill of materials</summary>
...
|-----------------|-----------------------------------|-----------------------------------------------|------------------------------------|
| LDO Mini Fridge door   | Mod for fridge-style door on Voron V0   | <Image src={imgFridgeDoor} alt="LDO Mini Fridge door" width={300} />    | [Mini Fridge repo](https://github.com/TheVoronModder/MiniFridge) <br /> [Larger latch](https://www.printables.com/model/1097609-voron-02-mini-fridge-ldo-formbot-inner-door-latch/comments) |
